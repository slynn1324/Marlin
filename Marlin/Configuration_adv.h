...
#define INPUT_SHAPING_Y
  ...
  #define SHAPING_MAX_STEPRATE 40000
 ...
 */
  ...
  // SL - default, and configured in https://github.com/bigtreetech/Marlin/blob/SKR-mini-E3-V3.0-G0B1/Marlin/Configuration_adv.h, 
  // but https://www.klipper3d.org/TMC_Drivers.html recommends no (so... 1?).  
   ...
   */
  #define DISABLE_STEALTHCHOP 1

  #if HAS_STEALTHCHOP && !DISABLE_STEALTHCHOP
    // SL disable stealthchop
